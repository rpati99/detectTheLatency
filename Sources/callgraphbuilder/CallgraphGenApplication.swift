...
public class CallgraphGenApplication {
    ...
    static func exportCallGraphAsCode(codebaseCallgraph: [OrderedDictionary<String, [String]>]) -> String {
        ...
        output += """
            ...
            func updateExecutionTime(for functionName: String, syncTime: Double, asyncTime: Double) {
    ...
    static func createCallGraphLoggerFile(at projectPath: String, callGraphData: [OrderedDictionary<String, [String]>]) {
        ...
        guard let sourceFolder = findSourceDirectory(in: projectPath) else {
            print("❌ Error: Could not locate the source directory inside \(projectPath)")
            return
        }
        ...
        do {
            ...
            print("✅ Successfully injected CallGraphLogger.swift into the codebase at: \(filePath)")
        } catch {
            print("❌ Failed to write CallGraphLogger.swift: \(error.localizedDescription)")
        }
    }
    ...
    static func findSourceDirectory(in projectPath: String) -> String? {
        ...
        do {
            ...
            print("❌ Error locating source directory: \(error.localizedDescription)")
        }
